...
$siteList = array('nettuts', 'flashtuts', 'webdesigntutsplus', 'psdtuts', 'vectortuts', 'phototuts', 'mobiletuts', 'cgtuts', 'audiotuts', 'aetuts');
...
if (filemtime($cache) < (time() - 10800)) {
	...
	$path .= urlencode("SELECT * FROM feed WHERE url='http://feeds.feedburner.com/thesartorialist'");
	$path .= "&format=json";
